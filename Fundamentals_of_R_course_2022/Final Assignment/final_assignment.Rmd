...
setwd("~/Documents/GitHub/Fundamentals_of_R_IHEID2022/Fundamentals_of_R_course_2022/Final Assignment")
...
co2 <- co2 %>% 
  pivot_longer(3:34, names_to="year", values_to= "co2_emissions") %>% 
...
gdp <- gdp %>% separate(1, sep="_", into=c("country_name", "country_code")) #tidy
