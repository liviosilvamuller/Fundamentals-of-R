...
untidy_burgers <- read_excel("~/Documents/GitHub/Fundamentals_of_R_IHEID2022/Lecture 3/Lecture_3_Presentation/assets/data/untidy_dat2.xlsx", 
...
tidy_burgers <- pivot_wider(untidy_burgers,names_from=joint, values_from=grade)
