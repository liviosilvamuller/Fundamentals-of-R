...
The `phd_theses.rds` file contains information on theses' author and year. Merge this dataset to the datasets from question 1 and question 2. The new "phd_theses" dataset should contain the following variables:
