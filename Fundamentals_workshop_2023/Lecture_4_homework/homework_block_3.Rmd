...
Create a scatter plot containing all theses over time that have a sustainability score ('sus_degree') bigger than 0. Please color the points by department ('thesis_department') and size them by their sustainability score ('sus_degree') (Tip: filter brfor plotting). What does the plot tell you?
