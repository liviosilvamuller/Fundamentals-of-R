...
b) What is the median year for PhD theses written in the PhD in Anthropology and Sociology program?
...
b) A lot of PhD theses do not have a program specified and are categorized as "No specialisation". Could you please change this category within the program variable to "Not Available" (hint: brackets can help here or you can find help [here](https://stackoverflow.com/questions/5824173/replace-a-value-in-a-data-frame-based-on-a-conditional-if-statement)).
...
c) How many PhD theses that have the word "development" in their title were written before the year 2000? What about after the year 2000 (hint: ´subset()´ accepts multiple conditions)? Can you interpret these results?
