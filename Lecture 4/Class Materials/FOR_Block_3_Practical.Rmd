...
Code chunks can be evaluated (run code?), included (should it be displayed in knitted document?), and much more. [rmarkdown](https://rmarkdown.rstudio.com/), as a [tidyverse](https://www.tidyverse.org/) package, also has a [cheat sheet](https://www.rstudio.com/resources/cheatsheets/)!
...
Before we start, the holy grail duide of visualizations [books](https://ggplot2-book.org/introduction.html), using the ggplot2 package, is open source and was written in R Markdown.
...
The '+', instead, adds layers to a ggplot2 plot (for more information see [here](https://stackoverflow.com/questions/35332861/what-is-the-difference-between-the-operator-in-ggplot2-and-the-operato))
