...
Before we start, the [ggplo2 book](https://ggplot2-book.org/introduction.html) is a great source for you to learn the details of visualizing with ggplot (and it was written using an RMarkdown).
