...
- `pivot_wider()` extends data by tidying data with more than one variable per column.
...
- `pivot_wider()` extends (horizontally) data by tidying data with more than one variable per column.
