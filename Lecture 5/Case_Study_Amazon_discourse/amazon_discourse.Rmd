---
title: How has the Brazilian Amazon been constructed as a problem:presidential speeches
  and transnational politics since 1985
...
```{r figure1, echo=FALSE, fig.cap="The Amazon Forest", out.width = '75%', include=TRUE}
...
```{r figure2, echo=FALSE, fig.cap="Operationalization of problem-constructions", out.width = '100%', include=TRUE}
...
```{r logistic, warning=FALSE, message=FALSE, include=TRUE}
...
```{r table 1, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, include=TRUE, results="asis"}
...
```{r fixed effects, echo=TRUE, include=TRUE}
...
```{r Figure 3, fig.cap="Logistic Regression predicted values", echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, include=TRUE}
# other models
...
```{r Table 2, fig.cap="Logistic Regressions Output", echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, include=TRUE, results="asis"}
