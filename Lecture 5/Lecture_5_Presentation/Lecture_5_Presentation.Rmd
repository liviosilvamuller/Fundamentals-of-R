...
--
  ...
  - Remember: there are many characteristics you can change on plots (size, color, fill, alpha,...)
    - If you include characteristics inside the `mapping=aes()`, mapping a variable to an aesthetic and *a legend will appear*.
...
**We will hold office hours normally for the next 2 weeks, but we will not solve the final assignment with you**
