...
setwd("~/Desktop/Fundamentals of R/Final Assignment")

co2 <- read_excel("API_EN.ATM.CO2E.KT_DS2_en_csv_v2_4666418.xlsx")
country_region <- read_csv("country_region.csv")
pop_dat <- readRDS("~/Desktop/Fundamentals of R/Final Assignment/pop_dat.rds")
gdp <- readRDS("~/Desktop/Fundamentals of R/Final Assignment/gdp.rds")
